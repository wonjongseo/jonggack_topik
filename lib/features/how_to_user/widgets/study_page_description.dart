...
class StudyPageDescription extends StatelessWidget {
  const StudyPageDescription({super.key});
          ...
          const Text.rich(
            TextSpan(
              ...
              children: [
                ...
                TextSpan(text: '가 있다면 한자도 함께 학습합니다.\n\n'),
                TextSpan(text: ' JLPT 단어를 학습하면서 한자의 정보를 확인하면 하트가 필요합니다.'),
                TextSpan(text: '(하트는 시험에서 모든 단어를 맞추면 채워집니다)\n\n'),
