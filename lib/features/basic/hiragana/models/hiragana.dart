  ...
  Hiragana(
    ...
    subHiragana: [
      ...
      SubHiragana(
        ...
        kSound: '누',
        eSound: 'nu',
        examples: [Example(yomikata: '-', word: 'ヌテラ', mean: '누텔라')],
      ),
      SubHiragana(
        hiragana: 'ネ',
        kSound: '네',
  ...
  Hiragana(
    ...
    subHiragana: [
      ...
      SubHiragana(
        ...
        kSound: '오',
        eSound: 'wo',
        examples: [Example(yomikata: '-', word: 'ヲタク', mean: '오타쿠')],
      ),
      SubHiragana(
        hiragana: 'ン',
        kSound: '응',
  ...
  Hiragana(
    ...
    subHiragana: [
      ...
      SubHiragana(
        ...
        kSound: '오',
        eSound: 'wo',
        examples: [Example(word: "~を", yomikata: "~を", mean: "~를")],
      ),
      SubHiragana(hiragana: 'ん', kSound: '응', eSound: 'n', examples: []),
    ],
  ),
];
// import 'package:jonggack_topik/model/example.dart';
