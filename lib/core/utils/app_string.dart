...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ja_JP': {
      ...
      AppString.unit: AppString.unitJp,
      ...
      AppString.second: AppString.secondJp,
      ...
      AppString.changedSystemLanguageMsg: AppString.changedSystemLanguageMsgJp,
      ...
      AppString.another: AppString.anotherJp,
      ...
      AppString.appSetting: AppString.appSettingJp,
      AppString.proun: AppString.prounJp,
      AppString.speedRate: AppString.speedRateJp,
      AppString.volumn: AppString.volumnJp,
      AppString.pitch: AppString.pitchJp,
      AppString.quizDuration: AppString.quizDurationJp,
      AppString.whenIncorrect: AppString.whenIncorrectJp,
    ...
    'ko_KR': {
      ...
      AppString.unit: AppString.unitKr,
      ...
      AppString.changedSystemLanguageMsg: AppString.changedSystemLanguageMsgKr,
...
class AppString {
  ...
  // Book
  static String bookCtlHint = "bookCtlHintTr";
  ...
  static String isDeletedKr = '가 삭제되었습니다.';
  static String isDeletedJp = "が削除されました。";
  static String isDeletedEn = "Cancel";

  static String savedWordText = "savedWordTextTr";
  static String savedWordTextKr = '저장된 단어:';
  static String savedWordTextJp = "保存された単語：";
  static String savedWordTextEn = "Cancel";

  static String unit = "unitTr";
  static String unitKr = '개';
  static String unitJp = "個";
  static String unitEn = "";

  static String word = "wordTr";
  static String wordKr = '단어';
  static String wordJp = "単語";
  static String wordEn = "";

  static String mean = "meanTr";
  static String meanKr = '의미';
  static String meanJp = "意味";
  static String meanEn = "";

  static String yomikata = "yomikataTr";
  static String yomikataKr = '발음';
  ...
  static String doQuizAllMissedWordsKr = '모든 단어로 퀴즈';
...
""";
  ...
  static String prounJp = '発音';
  static String prounEn = "";

  static String speedRate = "speedRateTr";
  static String speedRateKr = '속도';
  static String speedRateJp = '速さ';
  static String speedRateEn = "";

  static String volumn = "volumnTr";
  static String volumnKr = '음량';
  static String volumnJp = '音量';
  static String volumnEn = "";

  static String pitch = "pitchTr";
  static String pitchKr = '음조';
  static String pitchJp = '音調';
  static String pitchEn = "";

  static String quizDuration = "quizDurationTr";
  static String quizDurationKr = '퀴즈 진행 속도';
  static String quizDurationJp = 'QUIZ進行の速さ';
  static String quizDurationEn = "";

  static String whenIncorrect = "whenIncorrectTr";
  static String whenIncorrectKr = '맞출 시';
  static String whenIncorrectJp = '当てる時';
  static String whenIncorrectEn = "";

  static String whenCorrect = "whenCorrectTr";
  static String whenCorrectKr = '틀릴 시';
  static String whenCorrectJp = '間違える時';
  static String whenCorrectEn = "";

  static String fontSize = "fontSizeTr";
  static String fontSizeKr = '폰트 사이즈';
  static String fontSizeJp = 'フォントサイズ';
  static String fontSizeEn = "";

  static String init = "initTr";
