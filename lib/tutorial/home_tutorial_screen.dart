...
import 'package:jonggack_topik/features/how_to_user/screen/how_to_use_screen.dart';
...
import 'package:jonggack_topik/features/search/widgets/searched_word_card.dart';
...
import 'package:jonggack_topik/tutorial/home_tutorial.dart';
...
class _HomeTutorialScreenState extends State<HomeTutorialScreen> {
  ...
  void initState() {
    ...
    homeTutorialService.pageController = PageController(
          ...
          children: [
            ...
            ListTile(
              ...
              title: TextButton(
                onPressed: () {
                  Get.back();
                  Get.toNamed(SETTING_PATH, arguments: {'isSettingPage': true});
                },
                child: Text(
                  '설정 페이지',
                  style: TextStyle(
